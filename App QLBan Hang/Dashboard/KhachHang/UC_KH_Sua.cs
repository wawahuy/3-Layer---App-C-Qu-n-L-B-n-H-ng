...
{
    public partial class UC_KH_Sua : UserControl
    {
        ...
        public UC_KH_Sua(DTO.DTOKhachHang kh)
        {
            InitializeComponent();
            khachhang = kh;

            txb_hoten.Text = kh.Ten;
            txb_gioitinh.selectedIndex = kh.Giotinh ? 1 : 0;
            txb_cmnd.Text = kh.Cmnd;
            txb_ngaysinh.Value = kh.Ngaysinh;
        ...
        {
            DTO.DTOKhachHang kh = suaNhanVien();
        }
        ...
        private DTO.DTOKhachHang suaNhanVien()
        {
            if (!checkTextBox())
            {
            ...
            bool status = (new BUS.BUSKhachHang()).sua(kh);
        ...
        private bool checkTextBox()
        {
            ...
            else if(new BUS.BUSKhachHang().tonTaiCMND(txb_cmnd.Text) && !Regex.IsMatch(khachhang.Cmnd, txb_cmnd.Text))
            {
